const projectData = {
    "data": {
        "project": [
            ...
            {
                "id": "2",
                "title": "Yelp Data Analysis and Review Prediction",
                "company": "SFU",
                "location": "Canada",
            ...
            {
                "id": "3",
                "title": "International Border Alert System",
                "company": "SFU",
                "location": "Canada",
                "date": "Dec 2017 - Apr 2018",
                "work": [
                    "Developed a C++ codebase for an Arduino UNO microcontroller, integrating a GPS module to fetch live location data and implemented algorithms for accurate estimation of fishermen's distance from international maritime borders",
                    "Engineered a model boat system by seamlessly integrating hardware and software, enabling nuanced warnings based on live GPS data, effectively enhancing maritime safety near international borders"
                ]
            }
        ]
    }
